...
**Monster Overhaul** covers host-side aggression Harmony patches and client-side periodic enemy audio treatment. Code: `Systems/Audio/MonsterOverhaulSystem.cs` (audio loop); Harmony patches in `Systems/Patches/`.
